...
const { RtcTokenBuilder, RtcRole } = __nccwpck_require__(7774);
const { kAgoraAppCertificate, kAgoraAppId } = __nccwpck_require__(676);
...
module.exports = {
  RtcTokenBuilder: (__nccwpck_require__(241)/* .RtcTokenBuilder */ .H),
  RtcRole: (__nccwpck_require__(241)/* .Role */ .u),
  RtmTokenBuilder: (__nccwpck_require__(6701)/* .RtmTokenBuilder */ .p),
  RtmRole: (__nccwpck_require__(6701)/* .Role */ .u)
}
...
var UINT32 = (__nccwpck_require__(7821).UINT32);
var version = "006";
...
const AccessToken = (__nccwpck_require__(1864)/* .AccessToken */ .JO)
const Priviledges = (__nccwpck_require__(1864)/* .priviledges */ .hW)
...
module.exports.H = RtcTokenBuilder;
module.exports.u = Role;
...
module.exports.p = RtmTokenBuilder
module.exports.u = Role
...
exports.UINT32 = __nccwpck_require__(2090)
/* unused reexport */ __nccwpck_require__(186)
...
const { generateToken } = __nccwpck_require__(4210);
// middlewares
